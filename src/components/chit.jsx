        ...
        <>
                ...
                <div className='flex flex-col md:mr-20 mr-4'>
                        ...
                        <div className='first py-4 flex flex-col'>
                            <div className='flex flex-col md:flex-row gap-5 justify-between'>
                                <div className='flex flex-col'>
                                    ...
                                    <p className='font-light text-sm mt-4 font-poppins text-[#535353] text-left'>
                                    ...
                                    <p className='font-light text-sm font-poppins text-[#535353] text-left'>
                            ...
                            <p className='mt-2 font-light text-sm font-poppins text-[#535353] text-left'>
                            ...
                            <p className='font-medium text-sm font-poppins text-black items-center flex gap-2 text-left'>
                                <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Number of members in the chit fund scheme <span className='font-light text-sm font-poppins text-[#535353] text-left'>- 50</span>
                            </p>
                            <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Duration <span className='font-light text-sm font-poppins text-[#535353] text-left'>- 50 months</span>
                            </p>
                            {expandmore && (
                                <>  
                                    ...
                                    <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                        <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} /> Monthly instalment payable by each member  <span className='font-light text-sm font-poppins text-[#535353] text-left'>– Rs. 10,000/-</span>
                                    </p>
                                    <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                        <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Total pot value   <span className='font-light text-sm font-poppins text-[#535353] text-left'>– Rs. 5,00,000/- (50 members x 10,000)</span>
                                    </p>
                                    <p className='font-light text-sm font-poppins text-[#535353] text-left'>In this example, let us assume the winning Bid offered a 35% discount.</p>
                                    <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                        <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Discount offered by the winning Bid <span className='font-light text-sm font-poppins text-[#535353] text-left'> – 35%</span>
                                    </p>
                                    <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                        <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Amount of discount  <span className='font-light text-sm font-poppins text-[#535353] text-left'> – Rs. 1,75,000/- (35% of 5,00,000)</span>
                                    </p>
                                    <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                        <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Amount received by the winner   <span className='font-light text-sm font-poppins text-[#535353] text-left'>– Rs. 3,25,000/- (5,00,000 less 1,75,000)</span>
                                    </p>
                                    <p className='font-light text-sm font-poppins text-[#535353] text-left'>The balance amount is distributed equally among the members after deducting the Foreman’s commission.</p>
                                    <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                        <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Foreman’s commission <span className='font-light text-sm font-poppins text-[#535353] text-left'> – 5-7% = Rs. 25,000/-</span>
                                    </p>
                                    <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                        <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Total Dividend <span className='font-light text-sm font-poppins text-[#535353] text-left'>  – Rs. 1,75,000 less Rs. 25,000 = Rs. 1,50,000/-</span>
                                    </p>
                                    <p className='font-medium text-sm font-poppins text-black  items-center flex gap-2 text-left'>
                                        <img src={arrow} alt="Arrow" style={{ height: '16px', width: '16px' }} />Dividend credited to each member’s account   <span className='font-light text-sm font-poppins text-[#535353] text-left'> – 1,50,000/50 = Rs. 3,000/-</span>
                                    </p>
                                  
                                    
                                    <p className='font-light text-sm font-poppins text-[#535353] text-left'>So in the following month, the member will have to pay only ₹7,000(₹10,000-₹3,000) instead of ₹10,000.</p>
                    ...
                    {activeBtn === 'benefits' && (
                        <div className='second py-4 flex flex-col items-center justify-center'>
                            ...
                            <p className='font-light mt-4  text-sm font-poppins text-[#535353] text-center'>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
                                {cardsData.map((card, index) => (
                                    <div
                                        ...
                                        <p className={`text-gray-600  text-sm transition-all duration-300 ${expandedIndex === index ? 'h-auto' : 'h-16'}`}>
                            ...
                            <p className='font-light mt-4 font-poppins  text-sm text-[#535353] text-center'>
            ...
            <div className=' md:mt-5 flex bg-[#F5F5F5] flex-col items-center md:py-10 md:px-20 px-4 '>
                ...
                <div className='flex flex-col items-center justify-center lg:w-[70%] w-full'>
                    ...
                    <p className='font-light  font-poppins text-sm text-[#535353] text-center'>
