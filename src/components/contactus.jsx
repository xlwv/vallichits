    ...
    <>
      ...
      <div className='md:pl-20 pl-4 bg-[#F8F8F8] pt-10 md:pr-20 pr-4  flex flex-col pb-12 pt-4'>
        <div className='flex flex-col justify-center items-center'>
          ...
          <p className='font-light mt-3 font-poppins text-lg text-[#535353] text-justify'>
            ...
            <div>
              ...
              <div className='flex gap-2 flex-col'>
                <div className='flex gap-4 md:mt-32 mt-5 items-center'>
                  ...
                  <span className='font-poppins font-light text-lg text-white'>
                    +1012 3456 789
                  </span>
                </div>
            ...
            <form className="space-y-6">
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <label htmlFor="firstName" className="block text-lg font-poppins font-light text-gray-700">
                    First Name
                  </label>
                  <input
                    type="text"
                    id="firstName"
                    name="firstName"
                    className="mt-1 block w-full font-poppins border-gray-300 border-b-[1px] focus:border-black focus:outline-none sm:text-lg p-2"
                  />
                </div>
                <div className="flex-1">
                  <label htmlFor="lastName" className="block text-lg font-poppins font-light text-gray-700">
                    Last Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex-1">
                  <label htmlFor="email" className="block text-lg font-poppins font-light text-gray-700">
                    Email
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex-1">
                  <label htmlFor="phoneNumber" className="block text-lg font-poppins font-light text-gray-700">
                    Phone Number
                  </label>
                  <input
                    type="text"
              ...
              <div className='mt-5'>
                <label className="block text-lg font-bold font-poppins text-gray-700">Select Subject?</label>
                <div className="flex flex-wrap gap-4 mt-3">
                  {['General Inquiry', 'General Inquiry', 'General Inquiry', 'General Inquiry'].map(
                    (subject, index) => (
                      <label key={index} className="inline-flex font-poppins text-lg items-center">
                        <input
                          type="radio"
                          name="subject"
                          value={subject}
              ...
              <div className='mt-5'>
                <label htmlFor="message" className="block text-lg font-bold font-poppins text-gray-700">
                  Message
                </label>
                <textarea
                  id="message"
                  name="message"
                  rows="4"
                  className="mt-1 block w-full border border-gray-300 font-poppins focus:outline-none focus:border-black rounded-md shadow-sm  sm:text-lg p-2"
