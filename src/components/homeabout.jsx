...
<div className='flex md:flex-row flex-col-reverse gap-8 pb-8 pt-4 items-center justify-between'>
  ...
  <div className='flex flex-col  pl-4 md:pl-0 md:pr-24 pr-4'>
    ...
    <p className='font-light text-sm font-poppins leading-relaxed text-[#535353] tracking-wide text-justify mt-1'>
    ...
    <button
      className="font-poppins md:mt-16  bg-[#00be54] text-sm rounded-full text-white h-[40px] w-[116px]"
