...
function Homesec3() {
    return (
        <div className='bg-[#008080] relative flex justify-between h-fit  md:pr-20 pr-4 md:pl-20 pl-4 pt-8 gap-4'
        style={{
        ...
        <div className='w-[70%] relative flex flex-col pb-4 gap-4'>
            ...
            <span className='font-poppins text-xl font-medium text-md text-white font-bold'>
...
<img className='h-[50vh] w-[50pw] absolute bottom-0 right-0 md:right-12 md:block hidden' src={women}></img>
        </div>
    )
}
