...
function Journey() {
    return (
        ...
        <div className='flex items-center md:pr-20 pr-4 md:pl-20 pl-4  py-8 flex-col'>
            ...
            <div className='mb-4 flex items-center pt-4 justify-center mt-4 relative w-full p-3 bg-[#00BE54] rounded-full font-poppins text-white text-md '>
                ...
                <span
                    ...
                    className="absolute -top-5 rounded-full p-2 bg-white text-black font-poppins font-medium text-md">
                    LET'S ASSUME
            ...
            <span className='font-light text-md font-poppins  text-[#535353]  text-justify '><span className='text-[#00BE54] font-semibold text-md font-poppins        '>Note: </span> The pooled-in chit amount for the 1st month is retained by one of the members (Foreman). The above cycle/process of pool, auction, and the bid will be repeated each month from the second month onwards.</span>
            <span className='font-light text-md font-poppins  text-[#535353]  text-justify '>– One of the members</span>
