    ...
    return (
        ...
        <div className='flex  py-8 md:py-20 md:mx-20 mx-4 flex-col'>
            ...
            <div className='flex flex-col items-center'>
                ...
                <p className='team-description ml-2  mr-2 md:ml-20 md:mr-20 text-sm font-poppins text-[#535353] text-justify md:text-center mt-3'>
            ...
            <div
                ...
                <div className='flex border-black justify-between md:gap-6 md:pr-[15vw] items-center border-t h-[20vh] border-b'>
                    <div className='flex justify-between text-center  gap-2'>
                        <span className='font-poppins text-center flex items-center text-sm'>01</span>
                        <motion.span
                            initial={{ x: "0" }}
                            // animate={box1 ? { x: "9%" } : { x: "0%" }}.
                            animate={box1 && !isSmallScreen ? { x: "9%" } : { x: "0%" }}

                            className='font-poppins text-sm md:text-lg md:ml-20 font-semibold uppercase group-hover:text-[#00BE54]'>director and chairman</motion.span>
                    </div>
                    <motion.div
                        initial={{ scale: 0.5 }}
            ...
            <div
                ...
                <div className='flex justify-between md:gap-6 md:pr-[15vw] items-center  h-[20vh] '>
                    <div className='flex justify-between text-center  gap-2'>
                        <span className='font-poppins text-center flex items-center text-sm'>02</span>
                        <motion.span
                            initial={{ x: "0" }}
                            // animate={box1 ? { x: "9%" } : { x: "0%" }}.
            ...
            <div
                ...
                <div className='flex border-black justify-between md:gap-6 md:pr-[15vw] items-center border-t h-[20vh] border-b'>
                    <div className='flex justify-between text-center  gap-2'>
                        <span className='font-poppins text-center flex items-center text-sm'>03</span>
                        <motion.span
                            initial={{ x: "0" }}
                            // animate={box1 ? { x: "9%" } : { x: "0%" }}.
