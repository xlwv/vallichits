        ...
        <Slider {...settings}>
          <div className="p-4 ">
            <div className="bg-white p-6 rounded-xl border shadow-md">
              ...
              <p className="text-gray-600 text-lg font-poppins mb-4">
              ...
              <div className="flex items-center mt-4">
                ...
                <div className='flex flex-col'>
                  ...
                  <span className="text-lg font-poppins text-gray-600">Marketing Manager</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white p-6 rounded-xl border shadow-md">
              ...
              <div className="flex items-center  mt-4">
                ...
                <div className='flex flex-col'>
                  ...
                  <span className="text-lg font-poppins text-gray-600">Dentist</span>
                </div>
              </div>
            </div>
          </div>
